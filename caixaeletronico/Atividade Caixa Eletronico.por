programa
{
	...
	funcao processa_saque(inteiro valor_saque)
	{
		...
		// siga esta ideia para programar as duas linhas abaixo
		escreva("\nValor do saque: ", valor_saque)
		notas_50 = valor_saque/50
		valor_saque = valor_saque - (notas_50 * 50)
		escreva("\nNotas50: ", notas_50, " e valor do saque agora é ", valor_saque)
		escreva("\n")

		escreva("\nValor do saque: ", valor_saque)
		notas_20 = valor_saque / 20
		valor_saque = valor_saque - (notas_20 * 20)
		escreva("\nNotas20: ", notas_20, " e valor do saque agora é ", valor_saque)
		escreva("\n")

		escreva("\nValor do saque: ", valor_saque)
		notas_10 = valor_saque / 10
		valor_saque = valor_saque - (notas_10 * 10)
		escreva("\nNotas10: ", notas_10, " e valor do saque agora é ", valor_saque)
	}
